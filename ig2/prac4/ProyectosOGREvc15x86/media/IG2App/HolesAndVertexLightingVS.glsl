...
uniform mat4 normalMat; // matriz de transformación de normales
...
uniform vec3 materialDiffuse1; // datos del material ¡Front=Back!
uniform vec3 materialDiffuse2;
